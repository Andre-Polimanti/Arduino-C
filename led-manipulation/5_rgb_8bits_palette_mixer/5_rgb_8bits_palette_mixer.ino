...
void loop() {
  ...
  updateLedColoring(ledWriting); // You can add or update a color and it's intesity by adjusting the potentiometer before pressing the respective button, or turn everything off by pressing the designated button.
}
